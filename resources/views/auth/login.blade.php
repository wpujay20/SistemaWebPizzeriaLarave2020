      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Login de Acceso') }}</strong></h4>
            <div class="social-line">

                  <img src="{{asset('images/icono_la_buena_pizza.jpg')}}" style="width: 150px; border-radius: 10px;" alt="" />

            </div>
          </div>
          <div class="card-body">
            <p class="card-description text-center">{{ __('         ') }} <strong></strong> {{ __('       ') }}<strong> </strong> </p>
