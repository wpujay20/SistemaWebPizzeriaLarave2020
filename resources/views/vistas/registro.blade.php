                    ...
                    <form action="/">
                        <div style="display: flex;justify-content: space-between; ">
                            <div style="width: 40%;">
                                ...
                                <input type="text" id="fname" name="fname" placeholder="Nombre"></div>
                            <div style="width: 40%;">
                                <label for="fname">Apellidos:</label>
                                <input type="text" id="fname" name="fname" placeholder="Apellidos"></div>
                        </div><br>
                        <div style="display: flex;justify-content: space-between; ">
                            <div style="width: 30%;">
                                <label for="fname">DNI:</label>
                                <input type="number" maxlength="8" id="fname" name="fname" placeholder="N° DNI"></div>
                            <div style="width: 30%;">
                                <label for="fname">N° telefono fijo:</label>
                                <input type="text" id="fname" name="fname" placeholder="Telefono fijo"></div>
                            <div style="width: 30%;">
                                <label for="fname">N° movil:</label>
                                <input type="text" id="fname" name="fname" placeholder="Movil celular"></div>
                        </div><br>
                        <label for="lname">Correo Electronico:</label>
                        <input type="email" id="lname" name="lname" placeholder="Correo@example.com">
                        <br>
